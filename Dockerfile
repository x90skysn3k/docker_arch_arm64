...
RUN cd /tmp && curl -o install_arch.sh https://raw.githubusercontent.com/x90skysn3k/dotfiles/main/install_arch.sh && chmod +x ./install_arch.sh && ./install_arch.sh && rm -rf /tmp/*
